...
<html lang="en">
  <head>
    ...
    <title>Verify your VoiceyBill account</title>
  </head>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:16px;overflow:hidden;">
            <tr>
              <td style="background:#171717;padding:28px 32px;">
                ...
                <div style="margin-top:8px;font-size:14px;color:rgba(255,255,255,0.72);">Account verification</div>
              </td>
            </tr>
            <tr>
              <td style="padding:32px;">
                ...
                <p style="margin:0 0 24px;font-size:15px;line-height:1.7;color:#444;">
                  Use the one-time passcode below to verify your VoiceyBill account. The code expires in ${expiresInMinutes} minutes.
                </p>
