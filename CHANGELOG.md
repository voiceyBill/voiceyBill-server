...
## [2.0.0](https://github.com/voiceyBill/voiceyBill-server/compare/backend-v1.2.0...backend-v2.0.0) (2026-08-10)


### ⚠ BREAKING CHANGES

* **db:** DATABASE_URL is now required and MONGO_URI is no longer read. Production Postgres starts empty — existing accounts are not carried over.
...
* **db:** Replace MongoDB with Postgres ([34cc0e0](https://github.com/voiceyBill/voiceyBill-server/commit/34cc0e0ff6899f44a7c2769ab069f5af4ef4100e))
